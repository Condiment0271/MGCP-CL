...
def get_argparse():
    ...
    parser.add_argument("--knn_neighbors", type=int, default=4)
    parser.add_argument("--clustering_rate", type=float, default=0.3)
...
def get_config_from_args(args):
    ...
    config["nce_weight"] = args.nce_weight
    config["knn_neighbors"] = args.knn_neighbors
    config["clustering_rate"] = args.clustering_rate
